...
void AddDescriptors_brpc_2fstreaming_5frpc_5fmeta_2eproto();
namespace brpc {
class Feedback;
...
class StreamSettings :
 ...
 public:
  ...
  int extra_stream_ids_size() const;
  void clear_extra_stream_ids();
  static const int kExtraStreamIdsFieldNumber = 4;
  ::google::protobuf::int64 extra_stream_ids(int index) const;
  void set_extra_stream_ids(int index, ::google::protobuf::int64 value);
  void add_extra_stream_ids(::google::protobuf::int64 value);
  const ::google::protobuf::RepeatedField< ::google::protobuf::int64 >&
      extra_stream_ids() const;
  ::google::protobuf::RepeatedField< ::google::protobuf::int64 >*
      mutable_extra_stream_ids();
 ...
 private:
  ...
  ::google::protobuf::RepeatedField< ::google::protobuf::int64 > extra_stream_ids_;
...
// repeated int64 extra_stream_ids = 4;
inline int StreamSettings::extra_stream_ids_size() const {
  return extra_stream_ids_.size();
}
inline void StreamSettings::clear_extra_stream_ids() {
  extra_stream_ids_.Clear();
}
inline ::google::protobuf::int64 StreamSettings::extra_stream_ids(int index) const {
  // @@protoc_insertion_point(field_get:brpc.StreamSettings.extra_stream_ids)
  return extra_stream_ids_.Get(index);
}
inline void StreamSettings::set_extra_stream_ids(int index, ::google::protobuf::int64 value) {
  extra_stream_ids_.Set(index, value);
  // @@protoc_insertion_point(field_set:brpc.StreamSettings.extra_stream_ids)
}
inline void StreamSettings::add_extra_stream_ids(::google::protobuf::int64 value) {
  extra_stream_ids_.Add(value);
  // @@protoc_insertion_point(field_add:brpc.StreamSettings.extra_stream_ids)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int64 >&
StreamSettings::extra_stream_ids() const {
  // @@protoc_insertion_point(field_list:brpc.StreamSettings.extra_stream_ids)
  return extra_stream_ids_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int64 >*
StreamSettings::mutable_extra_stream_ids() {
  // @@protoc_insertion_point(field_mutable_list:brpc.StreamSettings.extra_stream_ids)
  return &extra_stream_ids_;
}
