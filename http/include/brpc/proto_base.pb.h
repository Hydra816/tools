...
void AddDescriptors_brpc_2fproto_5fbase_2eproto();
namespace brpc {
...
class SerializedResponseBase;
class SerializedResponseBaseDefaultTypeInternal;
extern SerializedResponseBaseDefaultTypeInternal _SerializedResponseBase_default_instance_;
...
template<> ::brpc::SerializedResponseBase* Arena::CreateMaybeMessage<::brpc::SerializedResponseBase>(Arena*);
...
class RedisRequestBase :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.RedisRequestBase) */ {
 public:
  RedisRequestBase();
...
class RedisResponseBase :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.RedisResponseBase) */ {
 public:
  RedisResponseBase();
...
class EspMessageBase :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.EspMessageBase) */ {
 public:
  EspMessageBase();
...
class MemcacheRequestBase :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.MemcacheRequestBase) */ {
 public:
  MemcacheRequestBase();
...
class MemcacheResponseBase :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.MemcacheResponseBase) */ {
 public:
...
class NsheadMessageBase :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.NsheadMessageBase) */ {
 public:
  NsheadMessageBase();
...
class SerializedRequestBase :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.SerializedRequestBase) */ {
 public:
...
class SerializedResponseBase :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.SerializedResponseBase) */ {
 public:
  SerializedResponseBase();
  virtual ~SerializedResponseBase();

  SerializedResponseBase(const SerializedResponseBase& from);

  inline SerializedResponseBase& operator=(const SerializedResponseBase& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  SerializedResponseBase(SerializedResponseBase&& from) noexcept
    : SerializedResponseBase() {
    *this = ::std::move(from);
  }

  inline SerializedResponseBase& operator=(SerializedResponseBase&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const SerializedResponseBase& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const SerializedResponseBase* internal_default_instance() {
    return reinterpret_cast<const SerializedResponseBase*>(
               &_SerializedResponseBase_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    7;

  void Swap(SerializedResponseBase* other);
  friend void swap(SerializedResponseBase& a, SerializedResponseBase& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline SerializedResponseBase* New() const final {
    return CreateMaybeMessage<SerializedResponseBase>(nullptr);
  }

  SerializedResponseBase* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<SerializedResponseBase>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
  void CopyFrom(const SerializedResponseBase& from);
  void MergeFrom(const SerializedResponseBase& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(SerializedResponseBase* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return nullptr;
  }
  ...
  // @@protoc_insertion_point(class_scope:brpc.SerializedResponseBase)
 private:
  class HasBitSetters;
...
class ThriftFramedMessageBase :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.ThriftFramedMessageBase) */ {
 public:
...
class BaiduMasterServiceBase_Stub;

class BaiduMasterServiceBase : public ::google::protobuf::Service {
 protected:
  // This class should be treated as an abstract interface.
  inline BaiduMasterServiceBase() {};
 public:
  virtual ~BaiduMasterServiceBase();

  typedef BaiduMasterServiceBase_Stub Stub;
 ...
 private:
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(BaiduMasterServiceBase);
};

class BaiduMasterServiceBase_Stub : public BaiduMasterServiceBase {
 public:
  BaiduMasterServiceBase_Stub(::google::protobuf::RpcChannel* channel);
  BaiduMasterServiceBase_Stub(::google::protobuf::RpcChannel* channel,
                   ::google::protobuf::Service::ChannelOwnership ownership);
  ~BaiduMasterServiceBase_Stub();

  inline ::google::protobuf::RpcChannel* channel() { return channel_; }

  // implements BaiduMasterServiceBase ------------------------------------------

 private:
  ::google::protobuf::RpcChannel* channel_;
  bool owns_channel_;
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(BaiduMasterServiceBase_Stub);
};
